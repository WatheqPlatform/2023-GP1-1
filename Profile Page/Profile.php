                        ...
                        <div id="DisplayContainer">
                            ...
                            <?php if (!empty($row['Twitter'])) { ?>
                                <p id="Contact">
                                    ...
                                    <a id="ContactLink" href="<?php echo $row['Twitter']; ?>" target="_blank"> <?php echo $row['Twitter']; ?></a>                             
                                </p>
                            <?php } ?>
                            ...
                            <?php if (!empty($row['Linkedin'])) { ?>
                                <p id="Contact">
                                    ...
                                    <a id="ContactLink" href="<?php echo $row['Linkedin']; ?>" target="_blank"> <?php echo $row['Linkedin']; ?></a>
                                </p>
                            <?php } ?>
                            ...
                            <?php if (!empty($row['Link'])) { ?>
                                <p id="Contact">
                                    ...
                                    <a id="ContactLink" href="<?php echo $row['Link']; ?>" target="_blank"> <?php echo $row['Link']; ?></a>
                                </p>
                            <?php } ?>
