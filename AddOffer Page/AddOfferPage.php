    ...
    <body>
        ...
        <div id="Main">
            ...
            <div id="Header">
                ...
                <div id="HeaderStart">
                    ...
                    <a href="../AddOffer Page/AddOfferPage.php" id="CurrentPage"> Add Offer </a> 
                </div>
                            ...
                            <div class="form_2 data_info" style="display: none;">
                                ...
                                <div class="form_container">
                                    <div class="input_wrap">  
                                        ...
                                        <input type="number" name="minSalary" class="input" id="minSalary" oninput="validateMinSalary()" >
                                        <span id="minSalaryError" style="color: red;"></span>
                                    </div>
                                    <div class="input_wrap">  
        ...
        <script>
            function validateMinSalary() {
                ...
                var minSalaryError = document.getElementById("minSalaryError");
                var minSalaryValue = minSalaryInput.value.trim();

                if (!/^\d+(\.\d+)?$/.test(minSalaryValue)) {
                    minSalaryError.textContent = "Please enter a valid number for the minimum salary.";
                } else {
